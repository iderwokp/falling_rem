...
//    Free_fall_widget fff{"ball.bmp", renderer, windows_height, windows_width, 200, Point{300,100}, 30, 20, 1, 0.9, true};
//    Free_fall_widget fefe{std::move(fff)};
    //Free_fall_widget fefe{fff};
//	int index{400};
	while(!quit) {
	//while(index--) {
